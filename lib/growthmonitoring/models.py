    ...
    def zscores(self, calculator):
        ...
        if age is not None:
            if self.weight is not None:
                self.weight4age = calculator.wfa(self.weight, D(age), gender)
            if self.height is not None:
                self.height4age = calculator.lhfa(self.height, D(age), gender)
        ...
        if self.weight is not None and self.height is not None:
            if age <= 24:
                self.weight4height = calculator.wfl(self.weight, D(age),
                                                    gender, self.height)
            elif age > 24:
                self.weight4height = calculator.wfh(self.weight, D(age),
                                                    gender, self.height)
            else:
                pass
        self.save()
